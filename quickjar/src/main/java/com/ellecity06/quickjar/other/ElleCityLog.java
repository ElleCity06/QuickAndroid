...
import com.ellecity06.quickjar.other.log.BaseLog;
import com.ellecity06.quickjar.other.log.FileLog;
import com.ellecity06.quickjar.other.log.JsonLog;
import com.ellecity06.quickjar.other.log.XmlLog;

import java.io.File;

/**
 * Log工具类，支持对文件，Xml，无限长度字符串的参数打印,
 * 此库里除了http库都用此日志打印，http做了特殊的处理，方便能够排查网络相关的异常
 *
 * @author: ellecity06
 * @e-mail: ellecity06@sina.com
 * @time: 2018/9/26 11:56
 */
public class ElleCityLog {
