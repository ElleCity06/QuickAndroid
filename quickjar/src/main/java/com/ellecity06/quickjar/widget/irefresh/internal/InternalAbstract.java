package com.ellecity06.quickjar.widget.irefresh.internal;
...
import com.ellecity06.quickjar.widget.irefresh.EnhancedECRefreshLayout;
...
public abstract class InternalAbstract extends RelativeLayout implements RefreshInternal {
    ...
    public SpinnerStyle getSpinnerStyle() {
        ...
        if (mWrappedView != null) {
            ...
            if (params instanceof EnhancedECRefreshLayout.LayoutParams) {
                mSpinnerStyle = ((EnhancedECRefreshLayout.LayoutParams) params).spinnerStyle;
                if (mSpinnerStyle != null) {
                    return mSpinnerStyle;
                }
            }
    ...
    public void onInitialized(@NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        if (mWrappedInternal != null && mWrappedInternal != this) {
            ...
            ViewGroup.LayoutParams params = mWrappedView.getLayoutParams();
            if (params instanceof EnhancedECRefreshLayout.LayoutParams) {
                kernel.requestDrawBackgroundFor(this, ((EnhancedECRefreshLayout.LayoutParams) params).backgroundColor);
            }
        }
    }
