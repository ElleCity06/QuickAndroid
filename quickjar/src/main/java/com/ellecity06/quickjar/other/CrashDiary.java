...
public class CrashDiary implements UncaughtExceptionHandler {
    ...
    private void collectDeviceInfo(Context ctx) {
        try {
            ...
            ElleCityLog.e(TAG, "an error occured when collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                ElleCityLog.e(TAG, field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                ElleCityLog.e(TAG, "an error occured when collect crash info", e);
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            ElleCityLog.e(TAG, "an error occured while writing file...", e);
        }
        return null;
    }
