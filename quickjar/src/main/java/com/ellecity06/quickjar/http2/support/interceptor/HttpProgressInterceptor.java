...
import com.ellecity06.quickjar.http2.support.body.ProgressRequestBody;
import com.ellecity06.quickjar.http2.support.body.ProgressResponseBody;
...
/**
 * 基本参考自JessYan的ProgressManager <a>https://github.com/JessYanCoding/ProgressManager</a>
 * @author: ellecity06
 * @e-mail: ellecity06@sina.com
 * @time: 2018/9/26 11:28
 */
@Singleton
public class HttpProgressInterceptor implements Interceptor {
    public static final int DEFAULT_REFRESH_TIME = 150;
    public static final String IDENTIFICATION_NUMBER = "?QuickAndroid=";
    public static final String IDENTIFICATION_HEADER = "QuickAndroid";
