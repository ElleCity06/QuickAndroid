...
public final class ActivityListManager {
    ...
    public Activity getTopActivity() {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when getTopActivity()");
            return null;
        }
    ...
    public void removeActivity(Activity activity) {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when removeActivity(Activity)");
            return;
        }
        synchronized (ActivityListManager.class) {
    ...
    public Activity removeActivity(int location) {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when removeActivity(int)");
            return null;
        }
        synchronized (ActivityListManager.class) {
    ...
    public void killActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when killActivity(Class)");
            return;
        }
        synchronized (ActivityListManager.class) {
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when activityInstanceIsLive(Activity)");
            return false;
        }
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when activityClassIsLive(Class)");
            return false;
        }
    ...
    public Activity findActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            ElleCityLog.w("mActivityList == null when findActivity(Class)");
            return null;
        }
        for (Activity activity : mActivityList) {
            if (activity.getClass().equals(activityClass)) {
