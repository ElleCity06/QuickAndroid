...
import com.ellecity06.quickjar.autosize.external.ExternalAdaptManager;
import com.ellecity06.quickjar.autosize.utils.Preconditions;
import com.ellecity06.quickjar.autosize.utils.ScreenUtils;
...
public final class AutoSizeConfig {
    ...
    AutoSizeConfig init(final Application application, boolean isBaseOnWidth, AutoAdaptStrategy strategy) {
        ...
        ElleCityLog.d("designWidthInDp = " + mDesignWidthInDp + ", designHeightInDp = " + mDesignHeightInDp + ", screenWidth = " + mScreenWidth + ", screenHeight = " + mScreenHeight);
            ...
            public void onConfigurationChanged(Configuration newConfig) {
                if (newConfig != null) {
                    if (newConfig.fontScale > 0) {
                        ...
                        ElleCityLog.d("initScaledDensity = " + mInitScaledDensity + " on ConfigurationChanged");
                    }
                    int[] screenSize = ScreenUtils.getScreenSize(application);
                    mScreenWidth = screenSize[0];
                    mScreenHeight = screenSize[1];
        ...
        ElleCityLog.d("initDensity = " + mInitDensity + ", initScaledDensity = " + mInitScaledDensity);
