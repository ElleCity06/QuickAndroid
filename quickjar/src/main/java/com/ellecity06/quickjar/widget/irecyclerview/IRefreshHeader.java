 ...
 */
public class IRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.ellecity_refresh_header, this);
        ImageView img = (ImageView) findViewById(R.id.iv_loading_refresh);

        animationDrawable = (AnimationDrawable) img.getDrawable();
        if (animationDrawable.isRunning()) {
            animationDrawable.stop();
        }
        msg = (TextView) findViewById(R.id.tv_refresh_text);
    ...
    private void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                msg.setText(R.string.loading_normal);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    ...
                    msg.setText(R.string.loading_hint_release);
                }
                break;
            case STATE_REFRESHING:
                msg.setText(R.string.loading_refreshing);
                break;
            case STATE_DONE:
                msg.setText(R.string.loading_refresh_done);
                break;
            default:
        }
        mState = state;
