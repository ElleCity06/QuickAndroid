package com.ellecity06.quickjar.widget.irefresh;
...
import com.ellecity06.quickjar.widget.irefresh.api.DefaultRefreshFooterCreator;
import com.ellecity06.quickjar.widget.irefresh.api.DefaultRefreshHeaderCreator;
import com.ellecity06.quickjar.widget.irefresh.api.DefaultRefreshInitializer;
import com.ellecity06.quickjar.widget.irefresh.api.RefreshContent;
import com.ellecity06.quickjar.widget.irefresh.api.RefreshFooter;
import com.ellecity06.quickjar.widget.irefresh.api.RefreshHeader;
import com.ellecity06.quickjar.widget.irefresh.api.RefreshInternal;
...
import com.ellecity06.quickjar.widget.irefresh.api.ScrollBoundaryDecider;
import com.ellecity06.quickjar.widget.irefresh.constant.DimensionStatus;
...
import com.ellecity06.quickjar.widget.irefresh.footer.BallPulseFooter;
import com.ellecity06.quickjar.widget.irefresh.header.LBXXHeader;
import com.ellecity06.quickjar.widget.irefresh.impl.RefreshContentWrapper;
import com.ellecity06.quickjar.widget.irefresh.impl.RefreshFooterWrapper;
import com.ellecity06.quickjar.widget.irefresh.impl.RefreshHeaderWrapper;
import com.ellecity06.quickjar.widget.irefresh.impl.ScrollBoundaryDeciderAdapter;
import com.ellecity06.quickjar.widget.irefresh.listener.OnLoadMoreListener;
import com.ellecity06.quickjar.widget.irefresh.listener.OnMultiPurposeListener;
import com.ellecity06.quickjar.widget.irefresh.listener.OnRefreshListener;
import com.ellecity06.quickjar.widget.irefresh.listener.OnRefreshLoadMoreListener;
import com.ellecity06.quickjar.widget.irefresh.listener.OnStateChangedListener;
import com.ellecity06.quickjar.widget.irefresh.listener.SimpleMultiPurposeListener;
import com.ellecity06.quickjar.widget.irefresh.util.DelayedRunnable;
import com.ellecity06.quickjar.widget.irefresh.util.DensityUtil;
import com.ellecity06.quickjar.widget.irefresh.util.ViscousFluidInterpolator;
...
import static com.ellecity06.quickjar.widget.irefresh.util.DensityUtil.dp2px;
import static com.ellecity06.quickjar.widget.irefresh.util.SmartUtil.fling;
import static com.ellecity06.quickjar.widget.irefresh.util.SmartUtil.getColor;
import static com.ellecity06.quickjar.widget.irefresh.util.SmartUtil.isContentView;
...
public class EnhancedECRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
    ...
    public EnhancedECRefreshLayout(Context context) {
        this(context, null);
    }

    public EnhancedECRefreshLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EnhancedECRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.EnhancedECRefreshLayout);

        mNestedChild.setNestedScrollingEnabled(ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableNestedScrolling, mNestedChild.isNestedScrollingEnabled()));
        mDragRate = ta.getFloat(R.styleable.EnhancedECRefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.EnhancedECRefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.EnhancedECRefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.EnhancedECRefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.EnhancedECRefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.EnhancedECRefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadMore = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableLoadMore, mEnableLoadMore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.EnhancedECRefreshLayout_srlHeaderHeight, mHeaderHeight);
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.EnhancedECRefreshLayout_srlFooterHeight, mFooterHeight);
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.EnhancedECRefreshLayout_srlHeaderInsetStart, mHeaderInsetStart);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.EnhancedECRefreshLayout_srlFooterInsetStart, mFooterInsetStart);
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableLoadMoreWhenContentNotFull, mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.EnhancedECRefreshLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.EnhancedECRefreshLayout_srlFixedHeaderViewId, mFixedHeaderViewId);
        mFixedFooterViewId = ta.getResourceId(R.styleable.EnhancedECRefreshLayout_srlFixedFooterViewId, mFixedFooterViewId);
        mHeaderTranslationViewId = ta.getResourceId(R.styleable.EnhancedECRefreshLayout_srlHeaderTranslationViewId, mHeaderTranslationViewId);
        mFooterTranslationViewId = ta.getResourceId(R.styleable.EnhancedECRefreshLayout_srlFooterTranslationViewId, mFooterTranslationViewId);

        if (mEnablePureScrollMode && !ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore = mManualLoadMore || ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlEnableLoadMore);
        mManualHeaderTranslationContent = mManualHeaderTranslationContent || ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlEnableHeaderTranslationContent);
        mManualFooterTranslationContent = mManualFooterTranslationContent || ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlEnableFooterTranslationContent);
        mManualNestedScrolling = mManualNestedScrolling || ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlEnableNestedScrolling);
        mHeaderHeightStatus = ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.EnhancedECRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;

        int accentColor = ta.getColor(R.styleable.EnhancedECRefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.EnhancedECRefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshHeader == null) {
                if (sHeaderCreator != null) {
                    ...
                    // 默认的
                    setRefreshHeader(new LBXXHeader(thisView.getContext()));
                }
            }
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = EnhancedECRefreshLayout.this;
                        for (ViewParent parent = thisView.getParent(); parent != null; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = EnhancedECRefreshLayout.this;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(EnhancedECRefreshLayout.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(EnhancedECRefreshLayout.this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(EnhancedECRefreshLayout.this);
    ...
    @Override
    public EnhancedECRefreshLayout setFooterHeight(float heightDp) {
    ...
    @Override
    public EnhancedECRefreshLayout setHeaderHeight(float heightDp) {
    ...
    @Override
    public EnhancedECRefreshLayout setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = dp2px(insetDp);
        return this;
    }

    @Override
    public EnhancedECRefreshLayout setFooterInsetStart(float insetDp) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public EnhancedECRefreshLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public EnhancedECRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public EnhancedECRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
     ...
     */
    @Override
    public EnhancedECRefreshLayout setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishRefresh(int delayed, final boolean success) {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(EnhancedECRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            EnhancedECRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                            EnhancedECRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishLoadMore(int delayed) {
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(EnhancedECRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            EnhancedECRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            EnhancedECRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
                        }
     ...
     */
    @Override
    public EnhancedECRefreshLayout finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return EnhancedECRefreshLayout.this;
        }
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return EnhancedECRefreshLayout.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
